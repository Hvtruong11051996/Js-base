...
//     const randomMonth = data[Math.floor(Math.random() * data.length)];
//     document.getElementById('title').innerHTML = randomMonth.quoteAuthor
//     document.getElementById('author').innerHTML = randomMonth.quoteText
